...
shape_predictor = "/home/ashok/Desktop/6th Semester/5HCI/project/HCI-project/Mouse_Cursor_Control_Handsfree-master/model/shape_predictor_68_face_landmarks.dat"
...
while True:
    ...
    if key == 27:
        print(mu,mr,ml,md,su,sd,lc,rc)
        endtime = time.time()
        duration = endtime-starttime
        print('Total time taken for the task ' + str(duration))
        break
